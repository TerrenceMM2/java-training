...
To make sounds visible to the Java compiler and JVM from any directory on your computer, perform the following steps:
...
2. On a Macintosh, copy the file sounds.jar to the following directory:
...
Alternatively, you can copy the directory sounds (the byte codes) to your working directory.  A command prompt compile or run will then be able to locate the package, but only from your current working  directory. 

You should also copy the sounddocs directory to you computer for browsable documentation.

The source code for the package is available in the directory soundswithsources.  It's Open Source.
